...
/** Flat node with expandable and level inWorldCup */
...
@Component({
  ...
  styleUrls: ['./tree-with-partially-loaded-data.component.css'],
  providers: [LoadmoreDatabase]
})
export class TreeWithPartiallyLoadedDataComponent implements OnInit {
